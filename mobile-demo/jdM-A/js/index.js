...
var banner = function () {
    /*1. 自动轮播图且无缝   定时器，c3的过渡*/
    /*2. 小点要随着图片的轮播改变  根据索引切换*/
    /*3. 滑动效果  利用touch事件完成*/
    ...
    /*需要等最后一张动画结束去判断 是否瞬间定位第一张  transitionend 过渡结束*/
    ...
    var startX = 0;
    var distanceX = 0;
    var isMove = false; // 判断轮播图是否滑动没有
    imageBox.addEventListener('touchstart', function (e) {
        /*清除定时器*/
        clearInterval(timer);
        /*记录起始位置的X坐标*/
        startX = e.touches[0].clientX; // touches事件是一个集合，所以有[0]
    });
